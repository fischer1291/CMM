...
import type { NotificationPrefs } from '../../services/notificationPrefs';
...
export function NotificationsView({ permission, prefs, onBack, onAllow, onOpenSettings, onChange }: Props) {
  return (
    <Screen scroll>
